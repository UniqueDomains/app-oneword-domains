# Available .APP One-Word Domains (64,405)

<p align="left">
  <img alt="status" src="https://img.shields.io/badge/status-active-2ea44f">
  <img alt="updated" src="https://img.shields.io/badge/updated-daily-0969da">
  <img alt="public extract" src="https://img.shields.io/badge/public%20extract-1%2C000%20rows-8250df">
  <img alt="live catalog" src="https://img.shields.io/badge/live%20catalog-64%2C405%20domains-6f42c1">
...
> The full live catalog for this exact search currently contains **64,405 domains** on the canonical page below.

**Public extract:** 1,000 rows · **Live catalog:** 64,405 domains · **Median ask:** $48.03 · **High-demand under $2,500:** 107
...
| ----------------------- | ------------------------------------------ |
| 1,000-row public sample | 64,405 live domains                        |
| Static CSV / JSON       | live search and daily refresh              |
| Basic exported fields   | 107 high-demand names under $2,500         |
...
> Unique Domains. *Available .APP One-Word Domains*. Version 2026-09-18. Public GitHub extract for the exact Unique Domains search represented by this repository.
